<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="mx-2">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 2.25h-7.5A2.25 2.25 0 0 0 6 4.5v15a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 19.5v-15A2.25 2.25 0 0 0 15.75 2.25zm-3.75 16.5a1.125 1.125 0 1 1 0-2.25 1.125 1.125 0 0 1 0 2.25zM12 6.75a1.125 1.125 0 1 1 0-2.25 1.125 1.125 0 0 1 0 2.25z" />
    </svg>
  </div>
  {{-- menu móvil --}}
